use master 
create database SHU_UNIVER 

on primary
	( name = N'SHU_UNIVER_mdf', filename = N'E:\2nd course\BD\Lab_4\SHU_UNIVER_mdf.mdf', 
		size = 5120Kb, maxsize = 10240Kb, filegrowth = 1024Kb), 
	( name = N'SHU_UNIVER_ndf', filename = N'E:\2nd course\BD\Lab_4\SHU_UNIVER_ndf.ndf', 
		size = 5120Kb, maxsize = 10240Kb, filegrowth = 10%), 
		
filegroup G1 
	( name = N'SHU_UNIVER_fg1_1', filename = N'E:\2nd course\BD\Lab_4\SHU_UNIVER_g1_1.ndf', 
		size = 10240Kb, maxsize = 15360Kb, filegrowth = 1024Kb), 
	( name = N'SHU_UNIVER_fg1_2', filename = N'C:\SHU_UNIVER\SHU_UNIVER_g1_2.ndf', 
		size = 2048Kb, maxsize = 5120Kb, filegrowth = 1024Kb), 
		
filegroup G2 
	( name = N'SHU_UNIVER_fg2_1', filename = N'E:\2nd course\BD\Lab_4\SHU_UNIVER_g2_1.ndf', 
		size = 5120Kb, maxsize = 10240Kb, filegrowth = 1024Kb), 
	( name = N'SHU_UNIVER_fg2_2', filename = N'E:\2nd course\BD\Lab_4\SHU_UNIVER_g2_2.ndf', 
		size = 2048Kb, maxsize = 5120Kb, filegrowth = 1024Kb) 
		
log on 
	( name = N'SHU_UNIVER_log', filename=N'C:\SHU_UNIVER\SHU_UNIVER_log.ldf', 
...
insert into PULPIT   (PULPIT, PULPIT_NAME, FACULTY )
	values	('ИСиТ', 'Информационных систем и технологий ','ИТ'),
			...
			('ОВ', 'Туризма, природопользования и охотоведения', 'ЛХФ');
...
create table SUBJECT
    (     SUBJECT      char(10)   constraint SUBJECT_PK  primary key, 
     SUBJECT_NAME varchar(100) unique,										--не 0, FK
